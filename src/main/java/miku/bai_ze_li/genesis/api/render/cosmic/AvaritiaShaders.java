...
import miku.bai_ze_li.genesis.api.render.cosmic.CCShaderInstance;
import miku.bai_ze_li.genesis.api.render.cosmic.CCUniform;
...
public final class AvaritiaShaders {
    ...
    @Mod.EventBusSubscriber(modid = GenesisLib.MODID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
